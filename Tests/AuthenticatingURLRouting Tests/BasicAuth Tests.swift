...
struct RFC_7617BasicRouterTests {
    ...
    func testParseInvalidRFC_7617BasicHeader() throws {
        ...
        do {
            ...
            #expect(
                parsed == nil,
                "Parsing should fail and return nil for an invalid Base64 header"
            )
        } catch {
    ...
    func testPrintRFC_7617BasicHeader() throws {
        ...
        #expect(
            printedHeader == expectedHeader,
            "The printed Authorization header should match the expected value."
        )
    }
    ...
    func testRoundTrip() throws {
        ...
        #expect(
            printedHeader == header,
            "Round trip parse and print should produce the same Authorization header."
        )
    ...
    func testParseEdgeCases() throws {
        ...
        #expect(
            parsed.password == "special!@chars$",
            "The password should match the expected value, including special characters."
        )
    }
}
